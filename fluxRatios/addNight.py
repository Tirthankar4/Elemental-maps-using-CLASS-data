...
def class_add_l1_files_time(night_data_files, op_base_dir, op_dir_location):
    ...
    count_ind_UTC_match = len(night_data_files)
   ...
   # if count_ind_UTC_match > 0:
    ...
    for idx, j in enumerate(night_data_files):
        ...
        filepath = op_base_dir + '/' + night_data_files[idx]
    ...
    summed_SCD_opfname = os.path.join(op_subdir_path, f'ch2_cla_l1_{interval_str}_{class_time_str}{fname_ext}')
...
if __name__ == '__main__':
    ...
    op_base_location = "/mnt/EVENmoreSTUFF/Lunar-Mapping/" 
    # UTC_start_user = '2021-08-28T06:22:57.451'
    # UTC_end_user = '2021-08-28T06:23:29.451'
    op_dir_location = '/mnt/EVENmoreSTUFF/Lunar-Mapping/generate_background'
    class_add_l1_files_time(night_data_files, op_base_location, op_dir_location)
